...
Route::middleware(['admin_auth','user_auth'])->group(function () {
    ...
    Route::get('category/{id}',[GuestController::class,'categoryDetails'])->name('guest.categoryDetails');
});
...
Route::middleware(['admin_auth','auth'])->group(function(){
    Route::prefix('admin_')->group(function(){
        ...
        Route::prefix('order')->group(function(){
            ...
            Route::get('getStatusAndCount',[OrderController::class,'getStatusAndCount'])->name('admin.getStatusAndCount');
...
Route::middleware(['user_auth','auth'])->group(function(){
