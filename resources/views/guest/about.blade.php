...
@section('content')
    ...
    <div class="text-place">
        <div class="row bg-danger px-5">
            ...
            <div class="col-md-8">
                ...
                <p class="text-muted">
                    Our team is here to help you improve your skills in your free time. We have so many lessons that cover your learning process through your daily routines.
                </p>
            </div>
        </div>
    </div>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        <h2>About Us</h2>
        <p>Our team is here to help you improve your skills in your free time. We have so many lessons that cover your learning process through your daily routines.</p>
      </div>
    </div><!-- End Breadcrumbs -->
