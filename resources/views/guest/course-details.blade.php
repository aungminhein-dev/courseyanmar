                ...
                <div class="col-lg-8 col-md-12 left-box">
                    <div class="card single_post">
                        <div class="body">
                            <div class="img-post">
                                @if ($course->image)
                                    <img class="d-block img-fluid" src="{{ asset('storage/' . $course->image) }}"
                                        alt="First slide">
                                @else
                                    <img class="d-block img-fluid" src="{{ asset('images/satellite-image-of-globe.jpg') }}"
                                        alt="First slide">
                                @endif
                            </div>
                            <a href="#">
                            ...
                            <a href="{{ route('user.buyPage', $course->id) }}" class="text-success">Purchase</a>
                            ...
                            <ul class="list-unstyled categories-clouds m-b-0">
                                @foreach ($categories as $c)
                                    <li class="@if ($c->id == $course->category->id) bg-primary rounded text-danger @endif"><a
                                            href="javascript:void(0);">{{ $c->name }} ({{ $c->courses_count }})</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
