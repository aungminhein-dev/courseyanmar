                    ...
                    @foreach ($popularCourses as $course)
                        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                            <div class="course-item">
                                @if ($course->image)
                                    <img src="{{ asset('storage/' . $course->image) }}" style="height: 300px;width:100%;object-fit:cover" class="img-fluid" alt="...">
                                @else
                                    <img src="{{ asset('images/satellite-image-of-globe.jpg') }}" style="height: 300px;width:100%;object-fit:cover" class="img-fluid" alt="...">
                                @endif
                                <div class="course-content">
                                    ...
                                    <p>{{Str::limit( $course->description,100, '...') }}<a href="{{ route('guest.courseDetails',$course->id) }}">see more</a></p>
